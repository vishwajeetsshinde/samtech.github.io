<%-- 
    Document   : byname
    Created on : 26 Oct, 2022, 5:11:38 PM
...
<html>
    ...
    <body>
        <%
            ...
            ResultSet rs=stmt.executeQuery("select fname,lname,dob,gender,dist,education,occupation from lagna where fname='"+fname+"' and lname='"+lname+"'");
        %>
